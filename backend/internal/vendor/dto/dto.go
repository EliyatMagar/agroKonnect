...
import (
	model "agro_konnect/internal/vendor/model"
	"time"
...
type CreateVendorRequest struct {
	...
	VendorType   model.VendorType `json:"vendor_type" validate:"required,oneof=seed_supplier fertilizer_supplier equipment_supplier pesticide_supplier irrigation_supplier"`
...
type VendorResponse struct {
	...
	BrandName    string           `json:"brand_name"`
	Description  string           `json:"description"`
	VendorType   model.VendorType `json:"vendor_type"`

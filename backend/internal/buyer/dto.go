...
type CreateBuyerRequest struct {
	...
	BusinessType  BuyerType     `json:"business_type" validate:"required,oneof=retailer wholesaler exporter processor restaurant supermarket"`
	BusinessScale BusinessScale `json:"business_scale" validate:"required,oneof=small medium large enterprise"`
...
type BuyerFilterRequest struct {
	BusinessType     BuyerType     `query:"business_type"`
	BusinessScale    BusinessScale `query:"business_scale"`
...
type BuyerResponse struct {
	...
	BusinessType  BuyerType     `json:"business_type"`
	BusinessScale BusinessScale `json:"business_scale"`
	Description   string        `json:"description"`

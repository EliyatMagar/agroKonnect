...
type CreateProductRequest struct {
	...
	Category    ProductCategory `json:"category" validate:"required,oneof=fruits vegetables grains dairy poultry livestock spices herbs"`
	...
	QualityGrade         QualityGrade `json:"quality_grade" validate:"oneof=premium standard economy"`
...
type UpdateProductRequest struct {
	...
	StorageTips string        `json:"storage_tips"`
	Status      ProductStatus `json:"status" validate:"oneof=draft active inactive sold_out expired"`
}
...
type ProductFilterRequest struct {
	...
	QualityGrade QualityGrade    `query:"quality_grade"`
